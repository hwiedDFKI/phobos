...
def register():
    ...
    bpy.types.World.exportOpenRave = BoolProperty(name="exportOpenRave", default=False, update=updateExportOptions)
...
class PhobosExportPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        c2.prop(bpy.data.worlds[0], "exportOpenRave", text="As OpenRave")
